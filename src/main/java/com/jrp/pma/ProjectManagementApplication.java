...
public class ProjectManagementApplication {
	...
	/* this method is used only to test the functionallity very fast; in general we used data.sql files
	 * @Bean CommandLineRunner runner() {
	 * 
	 * // lambda expression // this returns arguments when the entry point - the
	 * main above - // will start running. // this way we have a populated database
	 * return args -> {
	 * 
	 * // create the database entries Employee emp1 = new Employee("John", "Warton",
	 * "warton@gmail.com"); Employee emp2 = new Employee("Mike", "Lanister",
	 * "lanister@gmail.com"); Employee emp3 = new Employee("Steve", "Reeves",
	 * "Reeves@gmail.com");
	 * 
	 ...
	 * + "implementation");
	 * 
	 * // links among projects and employees
	 * 
	 * // need to set both sides of the relationship manually
	 * 
	 * pro1.addEmployee(emp1); // we need to addEmployee as a convenienve method
